  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (session) {
        ...
        const [certRes, earnedAchRes, allAchRes] = await Promise.all([
        ...
        setStats({ certificates: certs.length, badges: earned.length });
      } else {
                ...
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    {cert.certificate_url ? (
                      ...
                      <div className="bg-surface-container border-2 border-outline-variant rounded-lg py-3 font-bold text-sm flex items-center justify-center gap-2 text-on-surface-variant">
                        <Icon name="hourglass_empty" className="w-4 h-4" />
                        Menunggu file dari guru
                      </div>
                    )}
                  </div>
                </div>
